...
config_init:
	...
	OUT EIMSK,auxiliar
	LDI auxiliar,0xFF
	OUT DDRB,auxiliar; PORT B como salida
...
;**************************************************************
EXT_INT0:
	;Habilito la interrupción por overflow, y desactivo la interrupción del sensor
...
TIMER1_OVF:
	...
	OUT EIMSK,auxiliar_2
WAIT: RJMP WAIT; Espera a que se active la interrupción del sensor de movimiento
	RETI
